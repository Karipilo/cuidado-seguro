            ...
            <div className="container py-4">
                <div className="row text-center text-md-start align-items-center">
                    ...
                    <div className="col-md-4 mb-4 mb-md-0 text-center">
                        <img src="/images/logo.png" alt="Logo Cuidado Seguro" className="footer-logo mb-3" />
                        <h5 className="fw-bold">CONTÁCTANOS</h5>
                        <p className="mb-1">Teléfono de contacto:</p>
                        <p><a href="tel:+56964190492" className="link-footer">+56 9 6419 0492</a></p>
                        <p className="mb-1">Correo electrónico</p>
                        <p><a href="mailto:contacto@cuidadoseguro.cl" className="link-footer">contacto@cuidadoseguro.cl</a></p>
                    </div>
