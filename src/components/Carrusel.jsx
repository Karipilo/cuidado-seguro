...
function Carrusel() {
    return (
        ...
        <section className="container pb-5">
            <div id="carouselExample" className="carousel slide shadow-sm rounded overflow-hidden" data-bs-ride="carousel"
                ...
                <div className="carousel-inner">
                    ...
                    <div className="carousel-item">
                        <img src="images/eleam.png" className="d-block w-100" alt="Dashboard de Cuidado Seguro" />
                    </div>
                    <div className="carousel-item">
                        <img src="images/foto2.png" className="d-block w-100" alt="Dashboard de Cuidado Seguro" />
                    </div>
                    <div className="carousel-item">
